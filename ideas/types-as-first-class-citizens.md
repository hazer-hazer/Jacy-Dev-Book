...
At first, I thought it would be nice if we could use <span class="inline-code line-numbers highlight-jc hljs"><span class="hljs-keyword">type</span></span> for declaring not only aliases to types but also use them in
