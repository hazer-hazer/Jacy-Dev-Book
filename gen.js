...
class Generator {
    ...
    async _processFile(filePath, struct, title, {navOrder, parentTitle, parentNavOrder, isRoot = false}) {
    ...
    async _processDir(dirPath, struct, title, {navOrder, parentTitle, isRoot = false}) {
        const children = []
