...
like it more than C++ where we need to write <span class="inline-code highlight-jc hljs"><span class="hljs-keyword">const</span> <span class="hljs-operator">&amp;</span></span> or <span class="inline-code highlight-jc hljs">std::<span class="hljs-keyword">move</span></span> always everywhere.
...
will it print for function that accepts <span class="inline-code highlight-jc hljs">Struct {field: <span class="hljs-number">1234</span>}</span>? -- <span class="inline-code highlight-jc hljs">Struct</span> or <span class="inline-code highlight-jc hljs"><span class="hljs-operator">&amp;</span>Struct</span>.

As far as we don't remove references at all (they are still required to be in the language) -- the type is... 🥁🥁🥁
<span class="inline-code highlight-jc hljs"><span class="hljs-operator">&amp;</span>Struct</span>. Yeah, user have written <span class="inline-code highlight-jc hljs">Struct</span> but that's not the truth as all non-copy-types are passed by reference. And
...
cleared as we put <span class="inline-code highlight-jc hljs">free</span> at CT. The problem is not that <span class="inline-code highlight-jc hljs"><span class="hljs-type">Vec</span><span class="hljs-operator">&lt;</span>Struct<span class="hljs-operator">&gt;</span></span> is <span class="inline-code highlight-jc hljs"><span class="hljs-operator">&amp;</span><span class="hljs-type">Vec</span><span class="hljs-operator">&lt;</span>Struct<span class="hljs-operator">&gt;</span></span>... No, the problem is that is it
<span class="inline-code highlight-jc hljs"><span class="hljs-operator">&amp;</span><span class="hljs-type">Vec</span><span class="hljs-operator">&lt;</span>Struct<span class="hljs-operator">&gt;</span></span> or <span class="inline-code highlight-jc hljs"><span class="hljs-operator">&amp;</span><span class="hljs-type">Vec</span><span class="hljs-operator">&lt;</span><span class="hljs-operator">&amp;</span>Struct<span class="hljs-operator">&gt;</span></span>?! Rapidly answering this question I would say, it is a <span class="inline-code highlight-jc hljs"><span class="hljs-operator">&amp;</span><span class="hljs-type">Vec</span><span class="hljs-operator">&lt;</span>Struct<span class="hljs-operator">&gt;</span></span>, because having
<span class="inline-code highlight-jc hljs"><span class="hljs-operator">&amp;</span><span class="hljs-type">Vec</span><span class="hljs-operator">&lt;</span><span class="hljs-operator">&amp;</span>Struct<span class="hljs-operator">&gt;</span></span> we will require user to always have all <span class="inline-code highlight-jc hljs">Struct</span>s alive as long as <span class="inline-code highlight-jc hljs"><span class="hljs-type">Vec</span></span> is used, as far as it contains
references.
...
<span class="inline-code highlight-jc hljs">a <span class="hljs-operator">=</span> b</span> in Rust is <span class="inline-code highlight-jc hljs">a <span class="hljs-operator">=</span> <span class="hljs-keyword">move</span> b</span> but with PIR it will become <span class="inline-code highlight-jc hljs">a <span class="hljs-operator">=</span> <span class="hljs-operator">&amp;</span>b</span>, if <span class="inline-code highlight-jc hljs">b</span> is another variable of non-copy type.
...
Here, <span class="inline-code highlight-jc hljs">a</span> is of type <span class="inline-code highlight-jc hljs">StructType</span> because of move elision, but <span class="inline-code highlight-jc hljs">b</span> would be <span class="inline-code highlight-jc hljs"><span class="hljs-operator">&amp;</span>StructType</span> as it is automatically
borrowed.
