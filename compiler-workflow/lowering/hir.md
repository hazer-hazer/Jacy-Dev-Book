...
something". That is, the <span class="inline-code highlight-jc hljs">f<span class="hljs-operator">or</span>` <span class="hljs-keyword">loop</span> iterates over data until there<span class="hljs-symbol">&#x27;re</span> some data, same <span class="hljs-keyword">for</span> <span class="hljs-title class_">while</span> <span class="hljs-operator">and</span> `<span class="hljs-keyword">while</span> <span class="hljs-keyword">let</span></span>.
